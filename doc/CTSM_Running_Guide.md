...
**症状：** 编译时报错 `error #7013: This module file was not generated by any release of this compiler. [PIO]`

**原因：** PIO 的 `.mod` 文件由不同版本的 Intel 编译器生成，与当前编译器不兼容
...
**注意：** 如果不想使用 ctsm_pylib 环境，需要确保系统已安装所需的 Python 包（通过 pip 或系统包管理器）：
- netCDF4
- xarray
- numpy
- scipy
